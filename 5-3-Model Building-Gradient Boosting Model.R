...
# Brier Score
round(sum((test_shots$is.goal- pred.basic.gbm)^2) / nrow(test_shots),5) # 0.08093

# AUC ROC score
round(AUC(y_pred = pred.basic.gbm,y_true = test_shots$is.goal),5)
...
# Brier Score
round(sum((test_shots$is.goal- pred.complex.gbm)^2) / nrow(test_shots),5) # 0.07894

# AUC ROC score
round(AUC(y_pred = pred.complex.gbm,y_true = test_shots$is.goal),5)
...
# Brier Score
round(sum((test_shots$is.goal- pred.spat.gbm)^2) / nrow(test_shots),5) # 0.07794

# AUC ROC score
round(AUC(y_pred = pred.spat.gbm,y_true = test_shots$is.goal),5)
